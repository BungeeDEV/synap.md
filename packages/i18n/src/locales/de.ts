export default {
  ...
  settings: {
    ...
    healthTitle: 'Vault-Gesundheitscheck',
    healthSubtitle: 'Prüft den Vault auf defekte Wikilinks und Notes, auf die niemand verlinkt.',
    healthRefresh: 'Aktualisieren',
    healthReindexHint: 'Ergebnis wirkt veraltet?',
    healthReindexAction: 'Vault neu indexieren',
    healthReindexing: 'Indexiere…',
    healthReindexDone: '{indexed} von {total} Notes neu indexiert',
    healthReindexFailed: 'Neuindexierung fehlgeschlagen',
    healthCheckedAt: 'Zuletzt geprüft: {time}',
    healthLoadFailed: 'Gesundheitscheck konnte nicht geladen werden',
    healthRetry: 'Erneut versuchen',
    healthAllGood: 'Alles sauber — keine Probleme gefunden.',
    healthBrokenLinksTitle: 'Defekte Wikilinks',
    healthOrphanedNotesTitle: 'Verwaiste Notes',
    healthNoBrokenLinks: 'Keine defekten Wikilinks.',
    healthNoOrphanedNotes: 'Keine verwaisten Notes.',
    healthNeedsServer: 'Verbinde zuerst einen Server in den Sync-Einstellungen.'
},
  auth: {
  ...
  desktopApp: {
    ...
    syncStateSyncing: 'Synchronisiert…',
    syncStateError: 'Sync-Fehler',
    syncStateIdle: 'Synchronisiert',
    syncStatePending: '{count} ausstehend',
    syncConflictTitle: 'Sync-Konflikt erkannt',
    syncConflictBody: 'Serverversion wurde als Konfliktkopie gespeichert: {path}',
    dismiss: 'Schließen',
    attachmentTypeNotAllowed: 'Dateityp nicht erlaubt. Erlaubt: PNG, JPG, GIF, WebP, SVG, PDF.',
