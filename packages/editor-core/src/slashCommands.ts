...
export const getSlashCommands = (options: SlashCommandOptions): SlashCommand[] => [
  ...
  { id: 'image', label: 'Bild', icon: 'Image', group: 'insert', run: () => options.onAttachmentInsert('image') },
  { id: 'attachment', label: 'Datei-Anhang', icon: 'Paperclip', group: 'insert', run: () => options.onAttachmentInsert('file') },
