...
<template>
  <!-- Teleported to <body> so `fixed inset-*` always resolves against the
       real viewport, not whichever transformed ancestor happens to mount
       this - see ContextMenu.vue's own Teleport comment for the concrete bug
       this avoids. Self-contained here too, so any other future caller of
       this generic component gets the same guarantee for free. -->
  <Teleport to="body">
    <Transition
