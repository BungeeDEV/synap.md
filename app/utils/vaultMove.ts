...
/** Shared by VaultTree's native drag & drop and ContextMenuMoveSubmenu's picker, so both reject the same targets: dropping onto self, into a folder's own subtree, or into the current parent (no-op). */
